...
file_path_processed_data = r"C:\Users\chris\OneDrive - Universiteit Leiden\Documents\Paper 1\Supplementary Material - WIP 2nd submission\data\2 - processed data"
file_path_results = r"C:\Users\chris\OneDrive - Universiteit Leiden\Documents\Paper 1\Supplementary Material - WIP 2nd submission\data"
...
bovine_meat = pd.read_excel(file_path_processed_data + r"\TNC processing by weight.xlsx", sheet_name="Cattle weight").iloc[:, :-2]         # unit = tonnes
poultry_meat = pd.read_excel(file_path_processed_data + r"\TNC processing by weight.xlsx", sheet_name="Chickens weight").iloc[:, :-2]      # unit = tonnes
pig_meat = pd.read_excel(file_path_processed_data + r"\TNC processing by weight.xlsx", sheet_name="Pigs weight").iloc[:, :-2]              # unit = tonnes

# Read in dairy data which is already in weight (no need to convert)
dairy = pd.read_excel(file_path_processed_data + r"\TNC processing by weight.xlsx", sheet_name="Dairy")                       # unit = tonnes
